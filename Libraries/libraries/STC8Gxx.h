...
sbit        P00         =           P0^0;		//左电感采集
sbit        P01         =           P0^1;		//右电感采集
sbit        P02         =           P0^2;		//icm20602 角速度ad		 //6.22改：暂定为电磁adc采集
sbit        P03         =           P0^3;		//icm20602 角度ad		 //6.22改：暂定为电磁adc采集
sbit        P04         =           P0^4;		//左编码器	定时器3获取脉冲
sbit        P05         =           P0^5;		//左编码器	获取方向
sbit        P06         =           P0^6;		//无线转串口模块 使用串口4做频率发生器
sbit        P07         =           P0^7;		
sfr         SP          =           0x81;
sfr         DPL         =           0x82;
sfr         DPH         =           0x83;
...
sfr         INTCLKO     =           0x8F;
sfr         P1          =           0x90;
sbit        P10         =           P1^0;		//右电机 前进驱动
sbit        P11         =           P1^1;		//ADC采集 电容电压 发车
sbit        P12         =           P1^2;		//电磁ADC采集(中间水平电感)
sbit        P13         =           P1^3;		//线性CCD ad转换口
sbit        P14         =           P1^4;		//IIC SDA
sbit        P15         =           P1^5;		//IIC SCL
sbit        P16         =           P1^6;		//ADC采集 加速度计 车模转动（方向）
sbit        P17         =           P1^7;		//右电机驱动后退
sfr         P1M1        =           0x91;
sfr         P1M0        =           0x92;
sfr         P0M1        =           0x93;
sfr         P0M0        =           0x94;
...
sfr         IRTRIM      =           0x9F;
sfr         P2          =           0xA0;
sbit        P20         =           P2^0;		//线性CCD_CLK
sbit        P21         =           P2^1;		//线性CCD_SI
sbit        P22         =           P2^2;		//左电机 前进驱动
sbit        P23         =           P2^3;		//硬件ICM20602 MOSI
sbit        P24         =           P2^4;		//硬件ICM20602 MISO
sbit        P25         =           P2^5;		//硬件ICM20602 SCLK
sbit        P26         =           P2^6;		//左电机驱动后退
sbit        P27         =           P2^7;		//硬件ICM20602 CS		
sfr         P_SW1       =           0xA2;
sfr         IE          =           0xA8;
sbit        EA          =           IE^7;
sbit        ELVD        =           IE^6;
...
sbit        P32         =           P3^2;		//按键K0
sbit        P33         =           P3^3;		//按键K1
sbit        P34         =           P3^4;		//右编码器	定时器0捕获脉冲
sbit        P35         =           P3^5;
sbit        P36         =           P3^6;		//OLED的SCL
sbit        P37         =           P3^7;
sfr         P3M1        =           0xB1;
sfr         P3M0        =           0xB2;
sfr         P4M1        =           0xB3;
...
sfr         P4          =           0xC0;
sbit        P40         =           P4^0;		//按键K4
sbit        P41         =           P4^1;		//OLED的SDA
sbit        P42         =           P4^2;		//OLED的RST
sbit        P43         =           P4^3;		//OLED的DC
sbit        P44         =           P4^4;		//OLED的CS
sbit        P45         =           P4^5;
sbit        P46         =           P4^6;		//拨码开关2
sbit        P47         =           P4^7;		//右编码器		获取方向
sfr         WDT_CONTR   =           0xC1;
sfr         IAP_DATA    =           0xC2;
sfr         IAP_ADDRH   =           0xC3;
sfr         IAP_ADDRL   =           0xC4;
...
sbit        P50         =           P5^0;		//按键K2
sbit        P51         =           P5^1;	  //按键K3
sbit        P52         =           P5^2;		//uart串口RX			
sbit        P53         =           P5^3;		//uart串口TX	
sbit        P54         =           P5^4;		//蜂鸣器	
sbit        P55         =           P5^5;		
sbit        P56         =           P5^6;
sbit        P57         =           P5^7;
