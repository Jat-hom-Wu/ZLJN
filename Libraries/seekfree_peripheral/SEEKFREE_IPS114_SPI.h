...
#define	IPS114_SCL_PIN 		SPI2_SCLK_P25		//定义SPI_SCK引脚
#define	IPS114_SDA_PIN		SPI2_MOSI_P23   //定义SPI_MOSI引脚
#define	IPS114_SDA_IN_PIN	SPI2_MISO_P24   //定义SPI_MISO引脚  IPS屏幕没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用


#define IPS114_REST_PIN  	P32
#define IPS114_DC_PIN 	 	P33   	//液晶命令位引脚定义
#define IPS114_CS_PIN    	P35   	//定义SPI_CS引脚
#define IPS114_BL_PIN    	P36     //液晶背光引脚定义  
